...
public class LibraryApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			User user1 = new User("admin", pwEncoder.encode("test"), "nouredinelamine12@gmail.com", "Nouredine", "Dicko", "Huizumerlaan 158", "06-11433823", "dakar");
			user1.setRole("ROLE_ADMIN");

			User user2 = new User("employee", pwEncoder.encode("test"), "nounou13@gamail.com", "nounou", "Dicko", "Hugo de Grootstraat 174", "06-87054875", "dakar");
